...
const page = () => {
    ...
    // Int
    const int = `a = 719        # "a" is a variable which contains "719" as an integer.
...
f = """Hello World
    ...
    // List
    const List_1 = `a = ["ABC", 719, True, 12.95]`;

    const List_2 = `a = ["ABC", [12, 854]]`;
    const List_3 = `a = ["ABC", 719] # this list contains two elements first is "ABC" 
...
print(a[1]) # this will print 719.
    `;
    const List_4 = `a = ["ABC", [12, 854]]
print(a[1][0]) # it will print 12.
print(a[1][1]) # it will print 854.
    `;

    // Tuple
    const tuple_1 = `a = (12, "ABC")`;
    // Set
    const set_1 = `a = {719, "GS"}`;
                    ...
                    <div className='gridItem main_content'>
                        <div>
                            ...
                            <div id='int'>
                                ...
                                <br />
                                <div>
                                    {<CodeBox code={int} language="python" />}
                                </div>
                            </div>
                            <br />
                            <br />
                            ...
                            <div id='float'>
                                ...
                                <br />
                                {<CodeBox code={float} language="python" />}
                            </div>
                            <br />
                            <br />
                            <br />
                            <div id='str'>
                                ...
                                {<CodeBox code={str} language="python" />}
                            </div>
                            <br />
                            <br />
                            <br />
                            <div id='bool'>
                                ...
                                <br />
                                {<CodeBox code={bool_1} language="python" />}
                            </div>
                            <br />
                            <br />
                            <br />
                            <div id='list'>
                                ...
                                <br />
                                {<CodeBox code={List_1} language="python" />}
                                <br />
                                <p>A list can contains another list called nested list.</p>
                                <br />
                                {<CodeBox code={List_2} language="python" />}
                                <br />
                                ...
                                <ul className='ul_tag_Privacy'>
                                    ...
                                    {<CodeBox code={List_3} language="python" />}
                                    <br />
                                    <p>A list can contains another list called nested list.</p>
                                    <p>You can access these element by using indexing of indexing.</p>
                                    <br />
                                    {<CodeBox code={List_4} language="python" />}
                                </ul>
                            </div>
                            <br />
                            <br />
                            ...
                            <div id="tuple">
                                ...
                                <br />
                                <p>Example:</p>
                                {<CodeBox code={tuple_1} language="python" />}
                            </div>
                            <br />
                            <br />
                            <br />
                            <div id='set'>
                                ...
                                <br />
                                <p>Example:</p>
                                {<CodeBox code={set_1} language="python" />}
                            </div>
